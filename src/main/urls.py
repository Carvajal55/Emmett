...
urlpatterns = [
   ...
   # Ruta para la vista de creación de usuarios
    ...
    path('reingreso/', core_views.reingreso, name='reingreso'), # URL que apunta al HTML
   ...
   path('api/get-document/<int:document_number>/<int:document_type>/', core_views.get_bsale_document, name='get_bsale_document'),
   ...
   path('api/force-complete-product-with-superid/', core_views.force_complete_product_with_superid, name='force-complete-product-with-superid'),
   path('api/force-complete-product/', core_views.force_complete_product, name='force_complete_product'),
  ...
  # path('api/delete-products/', core_views.delete_products_from_excel, name='delete_products_from_excel'),
    path("api/actualizar_iderp_bsale/", core_views.actualizar_iderp_bsale, name="actualizar_iderp_bsale"),
